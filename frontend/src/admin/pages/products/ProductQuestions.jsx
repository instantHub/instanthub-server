...
//   const { prodQuesId, prodId } = useParams();
//   console.log("prodQuesId", prodQuesId, prodId);

//   const { data: productsData, isLoading: productLoading } =
//     useGetAllProductsQuery();
//   const { data: questionsData, isLoading } = useGetQuestionsQuery(prodQuesId);
//   const { data: produdctQuestionsData, isLoading: produdctQuestionsLoading } =
//     useGetProductQuestionsQuery(prodId);
//   const [
//     updateQuestion,
...
//   if (!productLoading) {
//     const productList = productsData.filter((product) => product.id == prodId);
...
//             <h1 className="bold text-[1.4rem] mb-2">Product Questions</h1>
//             <div className="flex items-center gap-1">
//               <h2>Home </h2>
//               <h2 className="pl-1"> / Product Question</h2>
...
//                 {!isLoading && <h1 className="text-2xl ">{product.name} </h1>}
